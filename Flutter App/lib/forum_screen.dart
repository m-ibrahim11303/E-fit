  ...
  Future<void> _createPost(BuildContext context) async {
    ...
    try {
      final response = await http.post(
          Uri.parse('https://e-fit-backend.onrender.com/post'),
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        await _loadPosts(
            showLoading: false); // Reload posts (will be reversed again)
        ScaffoldMessenger.of(context)
    ...
    if (_postsError != null)
      return Center(
          child: Padding(
              ...
              child: Text(_postsError!, textAlign: TextAlign.center)));
          ...
          child: Padding(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 16), // Post Content
                    Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          // Post Interactions
                          ...
                          _buildInteractionButton(
                              ...
                              count:
                                  currentComments?.length ?? commentMeta.length,
                              onTap: () => _toggleComments(postId),
                              isLoading:
                                  isLoadingComments && currentComments == null),
                        ]),
                    if (isExpanded)
                      _buildCommentsSection(postId, currentComments,
                          isLoadingComments), // Comments Section
                  ])),
        );
      },
    );
  ...
  Widget _buildCommentsSection(
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        SizedBox(height: 12),
        _buildCommentInputField(postId),
      ]),
    );
  }
  ...
  Widget _buildCommentInputField(String postId) {
    return Row(children: [
      Expanded(
        ...
        onSubmitted: (_) => _isPostingComment ? null : _postComment(postId),
      )),
      SizedBox(width: 8),
      IconButton(
          ...
          onPressed: _isPostingComment ? null : () => _postComment(postId),
