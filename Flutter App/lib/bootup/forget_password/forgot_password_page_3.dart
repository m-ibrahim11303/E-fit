  ...
  Widget _buildValidationItem(String text, bool isValid) {
    return Row(
      ...
      children: [
        ...
        Text(
          text,
          style: jerseyStyle(16, hintMaroon),
        ),
      ],
    );
  }
...
class ForgotPasswordPage3 extends StatefulWidget {
  final String email;
  final String code;
  const ForgotPasswordPage3({Key? key, required this.email, required this.code}) : super(key: key);
...
class _ForgotPasswordPage3State extends State<ForgotPasswordPage3> {
  ...
  Future<void> _updatePassword() async {
    ...
    final userData = {
      'email': widget.email,
      'code': widget.code,
      'newPassword': hashPassword(_newPasswordController.text.trim()),
    };
