...
import 'package:login_signup_1/style.dart'; // Assuming this contains jerseyStyle
import 'package:login_signup_1/bootup/signup_page_2.dart'; // Assuming SignUpPage2 is here
...
class _SignupPage1State extends State<SignupPage1> {
  ...
  // --- Navigation ---
  Future<void> _navigateToSignupPage2() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://10.130.93.109:3000/sign-up/send-code'),
